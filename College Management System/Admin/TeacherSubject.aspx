<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMst.Master" AutoEventWireup="true" CodeBehind="TeacherSubject.aspx.cs" Inherits="College_Management_System.Admin.TeacherSubject" %>
        ...
        <div class="container p-md-4 p-sm-4">
         ...
         <div class="row mb-3 mr-lg-5 ml-lg-5 mt-md-5">
            <div class="col-md-6">
                ...
                <div class="col-md-6">
                   <label for="ddlTeacher">&nbsp;&nbsp;Teacher</label></br>&nbsp;
                  <asp:DropDownList ID="ddlTeacher" runat="server" CssClass="form-Control" Height="46px" Width="321px">
                     </asp:DropDownList>
                    <br />&nbsp;
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="Teacher is Required." 
                        ControlToValidate="ddlTeacher" InitialValue="Select Teacher" Display="Dynamic" SetFocusOnError="True" ForeColor="Red">
                    </asp:RequiredFieldValidator>
                    <br />
               </div>    
            </div>
            ...
            <div class="row mb-3 mr-lg-5 ml-lg-5 ">
                <div class="col-md-6 col-md-offset-2 mb-3">
                    &nbsp;&nbsp;&nbsp;
                        <asp:Button ID="btnAdd" runat="server" Text="Assign Subject" CssClass="btn btn-primary btn-block"
        ...
        <div class="col-md-6 col-md-offset-2 mb-3">
            <asp:GridView ID="GridView1" runat="server" CssClass="table table-hover table-bordered" EmptyDataText="No Recorads Found..! " 
                     AutoGenerateColumns="False" AllowPaging="True" PageIndex="4" OnPageIndexChanging="GridView1_PageIndexChanging" 
                       ...
                       OnRowUpdating="GridView1_RowUpdating" OnRowDeleting="GridView1_RowDeleting" OnRowDataBound="GridView1_RowDataBound" Width="1016px" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
                <Columns>
